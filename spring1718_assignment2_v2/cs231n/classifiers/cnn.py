...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        # pass
        l1_out, l1_cache = conv_relu_pool_forward(X, self.params['W1'], self.params['b1'], conv_param, pool_param)
        l2_out, l2_cache = affine_relu_forward(l1_out, self.params['W2'], self.params['b2'])
        l3_out, l3_cache = affine_forward(l2_out, self.params['W3'], self.params['b3'])
        scores = l3_out
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dl2_out, grads['W3'], grads['b3'] = affine_backward(dscores, l3_cache)
        dl1_out, grads['W2'], grads['b2'] = affine_relu_backward(dl2_out, l2_cache)
        dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(dl1_out, l1_cache)
